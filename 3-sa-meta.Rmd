...
# note: 'overall' behavioral/attitude measurements taken from 
# analyses above
...
## TODO also: give readers a sense of how many are in each category
#
```
...
*paper*:  Breaking down these results by study type, we see a _negative_ correlation between attitudes and behaviors in observational research (-0.615057, p = 0.03329); a stronger, positive relationship within quasi-experimental research (0.3464049, p = 0.1054)); and a middling relationship within RCTs (0.1594935, p = 0.4364).

```{attitude_behavior_correlation_for_rcts_vs_observational}
