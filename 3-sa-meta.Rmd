...
# read in data, add in useful variables
...
Overall, 61 studies measure attitudinal and behavioral change silmultaneously. attitudes Y effect size, Behavior X effect size. Correlation: Z. correlation within RCTs: Q. 
