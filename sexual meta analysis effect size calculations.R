...
## moynihan -----------------------------------
did_calculator(mean_treatment_pre = 45.06, mean_treatment_post = 49.96, 
               mean_control_post = 48.67, mean_control_pre = 48.61, sd = 6.07)
...
## raymond -----------------------------------
### post
did_calculator(mean_treatment_pre = 4.64, mean_control_pre = 4.66, sd = .43, 
               mean_control_post = 4.5, mean_treatment_post = 4.19)

### 2 week follow
did_calculator(mean_treatment_pre = 4.64, mean_control_pre = 4.66, sd = .43, 
               mean_treatment_post = 4.4, mean_control_post = 4.45)

## rusinko -----------------------------------
did_calculator(mean_treatment_post = 21.04, mean_treatment_pre = 20.73, 
               mean_control_post = 20.64, mean_control_pre = 20.29, sd = 2.53)
...
## Kervin -----------------------------------=
log_odds_ratio(n_control = 35, n_treatment = 26, percent_control = .73, percent_treatment = .9)
...
### Rau -----------------------------------
did_calculator(mean_treatment_post = 21.92, mean_treatment_pre = 26.05, 
               mean_control_post = 24.3, mean_control_pre = 25.23, sd = 8.47)
...
taylor_b_n = 819.5
### attitude immediate
se_2_sd(se = .082, n = taylor_b_n)
se_2_sd(se = .094, n = taylor_b_n)

### attitude post
se_2_sd(se = .052, n = taylor_b_n)
se_2_sd(se = .057, n = taylor_b_n)

### victimization
se_2_sd(se = .346, n = taylor_b_n)
se_2_sd(se = .392, n = taylor_b_n)

### perp
se_2_sd(se = .225, n = taylor_b_n)
se_2_sd(se = .235, n = taylor_b_n)
