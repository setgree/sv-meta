...
dat %>% 
  ...
  tally()
# The following will fail for reasons that, because of the code below, 
# don't make sense to me -- might be a metafor bug
# dat %>% 
#   filter(scale_type == 'behavior', study_design != 'pre-post') %>%
#   split(list(.$study_design, .$yes_delay)) %>%
...
*Robustness check of reclassifying the low cluster studies  as RCTS*
