...
TODO: discrepancy with paper (103 vs 104 quasi studies, and 98 vs 99 observational studies)
```{r table_one}
dat |> 
...
TODO: 298 vs 304 studies. This is a big discrepancy!
...
TODO: it's down to 265 in America and up to 33 for everywhere else?
...
TODO: 28% of studies are only men
TODO: I thought we filled in all the NAs? 
```{r gender_breakdown}
dat |> # 
...
They target both men and women (30 studies, which constitute 61\% of all studies in this time frame), but a relatively high number of studies target only men (11 studies, or 22\% of all studies in this time frame). 
