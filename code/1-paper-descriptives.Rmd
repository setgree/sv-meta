...
> (The PRISMA Flow Diagram (Appendix Figure 1) explains how we winnowed the original pool of studies down to the 225 manuscripts)
...
> The database spans the years 1985-2018, encompassing 225 manuscripts that describe 298 studies, in which we coded 499 distinct point estimates.
...
> We observe that 265 studies which constitute 89% of the database were conducted in the United States. 
...
> Nearly 67\% of all studies are conducted within college campuses. Another 15\% are conducted in high schools, while 11\% are conducted in middle schools. Four percent of studies were conducted in the workplace, and three percent in community settings.
...
> In fact, 67% of the studies targeted both men and women, while 27\% targeted only men, and 6\% targeted only women.
...
> This is also apparent when looking at the type of publication; while 24 of these studies are from journal articles, 23 are from dissertations
...
> They target both men and women (34 intervention arms, which constitute 69\% of all studies in this time frame), but a relatively high number of studies target only men (11 studies, or 22\% of all studies in this time frame). 
...
> Overall, outcomes referring to an individual's ideas about sexual violence outnumber behavioral outcomes in our sample by 354 to 145. 
