...
> Unfortunately, in these studies, we find a small, statistically non-significant correlation of $\rho$ (59) = 0.141, p = 0.279 between changes in ideas and changes in behaviors.
...
> We find similar results when looking at the subset of randomized studies; ($\rho$ (25) = 0.16, p = 0.468); just at studies that measure both ideas about sexual violence and either victimization or perpetration  ($\rho$ (42) = 0.153, p = 0.322); and, finally, within randomized studies that measure ideas about sexual violence as well as either victimization or perpetration  ($\rho$ (59) = 0.141, p = 0.279).
...
# finally, perp and vict (and ideas) only in RCTs only
...
ggsave("../results/figures/att_beh_corr.pdf", width = 7.2, height = 7.2)

## TODO: compare line by line with JH's figure in 6-exploratory-analyses (
