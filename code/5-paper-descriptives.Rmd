...
Overall, mentalizing outcomes outnumber behavioral outcomes in our sample by 355 to 145. 207 studies
measure mentalizing outcomes only; 36 measure only behaviors; and 61 measure both
```{r}
...
Fig XXX displays the relationship between these outcomes over time.
...
ggsave("output/fig_att_beh_corr.pdf")
```
