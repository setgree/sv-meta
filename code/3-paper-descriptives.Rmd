...
ggsave("../results/in-paper-figures/tt_studies.pdf", height = 5)
```
...
ggsave("../results/in-paper-figures/descriptive.pdf", width = 7, height = 7)
```
...
ggsave("../results/in-paper-figures/tt_att_beh.pdf", height = 5)
```
...
ggsave("../results/in-paper-figures/tt_beh_type.pdf", height = 5)
```
...
ggsave("../results/in-paper-figures/att_beh_corr.pdf", width = 7.2, height = 7.2)
```