...
which(raw_dat$ctrl_sd == "") # double-checked these, should double-check before we go to press
...
which(is.na(as.numeric(raw_dat$ctrl_sd)) != is.na(raw_dat$ctrl_sd)) # lots!
...
# fix lab/field; I made a comment abou this one study  
